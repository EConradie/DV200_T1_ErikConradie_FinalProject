...
function Compare() {
    ...
    const [Driver1Selected, setDriver1Selected] = useState(0);
    const [Driver2Selected, setDriver2Selected] = useState(1);
    ...
    var Driver1Data = DriverDetails[Driver1Selected];
    ...
    var Driver2Data = DriverDetails[Driver2Selected];
